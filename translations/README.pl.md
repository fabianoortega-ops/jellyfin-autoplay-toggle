...
- [File Transformation](https://github.com/IAmParadox27/jellyfin-plugin-file-transformation) — Rozwiązuje problemy z uprawnieniami na Docker/TrueNAS. Wymagane przy błędach dostępu w JavaScript Injector.
